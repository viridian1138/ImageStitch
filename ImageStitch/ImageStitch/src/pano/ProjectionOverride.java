...
public class ProjectionOverride {
	
	
	protected static Integer projectionNum = null;
	
	
	protected static Integer projectionFieldOfView = null;


	public static Integer getProjectionNum() {
		return projectionNum;
	}


	public static void setProjectionNum(Integer projectionNum) {
		ProjectionOverride.projectionNum = projectionNum;
	}


	public static Integer getProjectionFieldOfView() {
		return projectionFieldOfView;
	}


	public static void setProjectionFieldOfView(Integer projectionFieldOfView) {
		ProjectionOverride.projectionFieldOfView = projectionFieldOfView;
	}
