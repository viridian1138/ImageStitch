...
public class PreStitch {
	...
	protected static void runPreRm() throws Throwable
	{
		handleStdCmd( "rm -rf stitch" );
		handleStdCmd( "rm -rf stitch_failed" );
	}
	
	
	protected static void runPreMkdir() throws Throwable
	{
		handleStdCmd( "mkdir stitch" );
		handleStdCmd( "mkdir stitch_failed" );
	}
	
	
	
	
protected static void handleStdCmd(final String command) throws Throwable {
